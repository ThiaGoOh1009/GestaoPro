...
export const ContasAReceberPage = () => {
    return (
        <div>
            <header className="mb-8">
                <h2 className="text-3xl font-bold text-white">Contas a Receber</h2>
            </header>
            <div className="text-center py-12 bg-gray-800 rounded-lg">
                ...
                <p className="mt-1 text-sm text-gray-400">
                    A funcionalidade de Contas a Receber agora faz parte do novo módulo unificado "Financeiro".
                </p>
                 <p className="mt-1 text-sm text-gray-400">
